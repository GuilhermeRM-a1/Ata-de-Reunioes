...
insert into reuniao (id, titulo, data, resumo, status_transcricao, status_reuniao, total_acoes) values
                                                                                                    (1,  'Alinhamento semanal de Operações',            '2026-06-02T09:00:00', 'Revisão dos indicadores da semana e redistribuição de escalas para o período de alta demanda.',   'CONCLUIDA',     'FINALIZADA',    2),
                                                                                                    (2,  'Comitê de Tecnologia — roadmap do trimestre', '2026-06-08T14:30:00', 'Definição das prioridades técnicas do trimestre e discussão da dívida acumulada no legado.',      'CONCLUIDA',     'FINALIZADA',    3),
                                                                                                    (3,  'Fechamento financeiro de maio',               '2026-06-15T10:15:00', 'Consolidação do resultado de maio, com desvio relevante na linha de manutenção predial.',         'CONCLUIDA',     'FINALIZADA',    2),
                                                                                                    (4,  'Café com RH — escuta de clima',               '2026-06-23T16:00:00', 'Conversa aberta sobre clima organizacional, sem encaminhamentos formais registrados.',            'CONCLUIDA',     'FINALIZADA',    0),
                                                                                                    (5,  'Revisão de contratos de fornecedores',        '2026-07-01T11:00:00', 'Análise dos contratos que vencem no semestre e definição da estratégia de renegociação.',         'CONCLUIDA',     'FINALIZADA',    2),
                                                                                                    (6,  'Planejamento de treinamento operacional',     '2026-07-07T08:45:00', 'Desenho da trilha de treinamento para novas contratações do time de operações.',                  'ANALISANDO',    'EM_ANDAMENTO',  1),
                                                                                                    (7,  'Retrospectiva trimestral integrada',          '2026-07-14T15:00:00', 'Retrospectiva com as quatro áreas, consolidando aprendizados e compromissos do próximo ciclo.',   'CONCLUIDA',     'FINALIZADA',    5),
                                                                                                    (8,  'Incidente de indisponibilidade — pós-morte',  '2026-07-21T18:20:00', 'Análise da indisponibilidade do ambiente de atendimento e das ações de contenção adotadas.',      'ERRO',          'FINALIZADA',    2),
                                                                                                    (9,  'Revisão de metas do segundo semestre',        '2026-07-29T13:30:00', 'Ajuste das metas do semestre com base no resultado parcial e na capacidade das equipes.',         'ANALISANDO',    'EM_ANDAMENTO',  1),
                                                                                                    (10, 'Kickoff do projeto de automação de atas',     '2026-08-03T09:30:00', 'Abertura do projeto de automação de atas, com escopo, papéis e primeiros marcos definidos.',      'TRANSCREVENDO', 'EM_ANDAMENTO',  2),
                                                                                                    (11, 'Auditoria interna de processos',              '2026-08-06T14:00:00', 'Apresentação dos achados preliminares da auditoria interna sobre processos de compras.',          'TRANSCREVENDO', 'EM_ANDAMENTO',  1),
                                                                                                    (12, 'Comitê de segurança da informação',           '2026-08-11T10:00:00', 'Revisão das políticas de acesso e do plano de resposta a incidentes de segurança.',               'RECEBIDA',      'PENDENTE',      1),
                                                                                                    (13, 'Alinhamento de contratações do trimestre',    '2026-08-14T17:00:00', 'Definição das vagas prioritárias do trimestre e do fluxo de aprovação das contratações.',         'RECEBIDA',      'PENDENTE',      2);
-- -------------------------------------------------------------- reuniao_areas
